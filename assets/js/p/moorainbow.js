...
var MooRainbow = new Class({
  Implements:    [ Options, Events ],
	...
	initialize: function(el, options) {
		...
		this.bg = new Element('div', { id: 'mooRainbowBg' });
	...
	show: function() {
		...
		this.resize_ref = this.resize.bind(this);
		this.keyboard_ref = this.keyboard.bind(this);
		$(window).addEvent('resize', this.resize_ref);
		$(window).addEvent('keydown', this.keyboard_ref);
	},
	...
	hide: function() {
		...
		$(window).removeEvent('resize', this.resize_ref);
		$(window).removeEvent('keydown', this.keyboard_ref);
		this.resize_ref = null;
		this.keyboard_ref = null;
	},
	...
	rePosition: function() {
		...
		this.layout.setStyles({
			left:((coords.x / 2) - (390 / 2)),
			top:((coords.y / 2) - (310 / 2))
		});
	},
